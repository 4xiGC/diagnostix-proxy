...
export const PLAN_RULE = [
  ...
  'horizon: when it should be done, as a period: "2 weeks", "30 days" or "90 days".',
  'indicator: one observable sign that it worked, with a number only where the data supports one, for example "fewer than 2 reviews a month mentioning slow service".',
...
export const PLAN_PROMPT_VERSION = 'plan-2026-10-01-' + crypto.createHash('sha256').update(PLAN_RULE).digest('hex').slice(0, 12);
